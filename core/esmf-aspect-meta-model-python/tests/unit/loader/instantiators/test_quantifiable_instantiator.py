"""QuantifiableInstantiator class unit tests suit."""
...
from esmf_aspect_meta_model_python.loader.instantiator.quantifiable_instantiator import QuantifiableInstantiator
from esmf_aspect_meta_model_python.vocabulary.SAMMC import SAMMC


class TestQuantifiableInstantiator:
    """QuantifiableInstantiator unit tests class."""

    @mock.patch("esmf_aspect_meta_model_python.loader.instantiator.quantifiable_instantiator.DefaultQuantifiable")
    def test_create_instance(self, default_quantifiable_mock):
        base_class_mock = mock.MagicMock(name="QuantifiableInstantiator_class")
        ...
        default_quantifiable_mock.return_value = "instance"
        result = QuantifiableInstantiator._create_instance(base_class_mock, "element_node")
        ...
        default_quantifiable_mock.assert_called_with("meta_model_base_attributes", "data_type", "unit")

    def test_create_instance_raise_exception(self):
        base_class_mock = mock.MagicMock(name="QuantifiableInstantiator_class")
        base_class_mock._get_data_type.return_value = None
        with pytest.raises(TypeError) as error:
            QuantifiableInstantiator._create_instance(base_class_mock, "element_node")
