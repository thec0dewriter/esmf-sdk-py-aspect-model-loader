...
from sds_aspect_meta_model_python.base.characteristics.code import Code
from sds_aspect_meta_model_python.impl.characteristics.default_code import DefaultCode
