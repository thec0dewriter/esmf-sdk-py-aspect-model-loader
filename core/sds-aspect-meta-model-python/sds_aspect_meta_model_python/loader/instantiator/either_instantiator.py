...
from sds_aspect_meta_model_python.base.characteristics.either import Either
from sds_aspect_meta_model_python.impl.characteristics.default_either import DefaultEither
