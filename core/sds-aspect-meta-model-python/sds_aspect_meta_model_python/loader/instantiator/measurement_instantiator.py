...
from sds_aspect_meta_model_python.impl.characteristics.quantifiable.default_measurement import DefaultMeasurement
...
class MeasurementInstantiator(InstantiatorBase[Measurement]):
    def _create_instance(self, element_node: Node) -> Measurement:
        ...
        unit = self._get_child(element_node, self._bammc.get_urn(BAMMC.unit), required=True)
