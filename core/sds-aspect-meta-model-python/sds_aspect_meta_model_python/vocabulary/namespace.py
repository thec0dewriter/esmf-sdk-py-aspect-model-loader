...
class Namespace(metaclass=abc.ABCMeta):
    ...
    def get_name(element_urn: Union[rdflib.URIRef, str, None]) -> Optional[str]:
        ...
        Example: get_name("urn:bamm:io.openmanufacturing:test:1.0.0#TestAspect") -> "TestAspect"
        Example: get_name("urn:bamm:io.openmanufacturing:meta-model:1.0.0#Characteristic") -> "Characteristic"
        """
