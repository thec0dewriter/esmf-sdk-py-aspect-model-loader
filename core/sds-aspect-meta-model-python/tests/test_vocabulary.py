...
from sds_aspect_meta_model_python.vocabulary.BAMME import BAMME
...
BAMM_VERSION = "2.0.0"
UNIT_URN = f"urn:bamm:io.openmanufacturing:unit:{BAMM_VERSION}#referenceUnit"
BAMME_URN = f"urn:bamme:io.openmanufacturing:meta-model:{BAMM_VERSION}#referenceUnit"
BAMMC_URN = f"urn:bamm:io.openmanufacturing:characteristic:{BAMM_VERSION}#constraint"
BAMM_URN = f"urn:bamm:io.openmanufacturing:meta-model:{BAMM_VERSION}#Aspect"
