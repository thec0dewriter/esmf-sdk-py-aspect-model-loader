...
from sds_aspect_meta_model_python import AspectLoader, Enumeration, ComplexType, AbstractEntity, Quantifiable
...
def test_aspect_with_abstract_entity():
    ...
    assert entity_property_characteristic.urn == "urn:bamm:io.openmanufacturing:characteristic:2.0.0#Text"
...
def test_aspect_with_abstract_coordinate_properties_list() -> None:
    ...
    assert float_3d_coordinate_properties[0].extends.urn == "urn:bamm:io.openmanufacturing:entity:2.0.0#x"
    ...
    assert float_3d_coordinate_properties[1].extends.urn == "urn:bamm:io.openmanufacturing:entity:2.0.0#y"
...
def test_aspect_with_time_series():
    ...
    assert time_series_entity.urn == "urn:bamm:io.openmanufacturing.test:1.0.0#TestTimeSeriesEntity"
...
def test_aspect_with_time_series_with_complex_type() -> None:
    ...
    assert data_type.urn == "urn:bamm:io.openmanufacturing.test:1.0.0#TestTimeSeriesEntity"
...
def test_aspect_with_file_resource_entity() -> None:
    ...
    assert fileResource.urn == "urn:bamm:io.openmanufacturing:entity:2.0.0#FileResource"
...
def test_aspect_with_entity_extending_file_resource() -> None:
    ...
    assert advancedFileResource.urn == "urn:bamm:io.openmanufacturing.test:1.0.0#AdvancedFileResource"
